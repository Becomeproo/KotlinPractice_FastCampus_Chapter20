package com.example.practicekotlin20.view
...
import com.example.practicekotlin20.databinding.ViewholderRepositoryItemBinding
...
class RepositoryRecyclerAdapter :
    ...
    inner class RepositoryItemViewHolder(
        ...
        fun bindData(data: GithubRepoEntity) = with(binding) {
            ...
            titleTextView.text = data.fullName
            subTitleTextView.text = data.description
